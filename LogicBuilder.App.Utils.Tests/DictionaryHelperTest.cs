...
namespace LogicBuilder.App.Utils.Tests
{
    public class DictionaryHelperTest
    {
        ...
        public void ToDictionary_WithSimpleKeyAndValue_CreatesDictionary()
        {
            ...
            // Act
            var result = helper.ToDictionary<Category, int, string>(categories, keySelector, valueSelector);
        ...
        public void ToDictionary_WithComplexKey_CreatesDictionary()
        {
            ...
            // Act
            var result = helper.ToDictionary<Product, int, string>(products, keySelector, valueSelector);
        ...
        public void ToDictionary_WithObjectValue_CreatesDictionary()
        {
            ...
            // Act
            var result = helper.ToDictionary<Category, int, Category>(categories, keySelector, valueSelector);
        ...
        public void ToDictionary_WithNestedProperty_CreatesDictionary()
        {
            ...
            // Act
            var result = helper.ToDictionary<Product, int, int>(products, keySelector, valueSelector);
        ...
        public void ToDictionary_WithDuplicateKeys_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() =>
                helper.ToDictionary<Category, int, string>(categories, keySelector, valueSelector));
        }
        ...
        public void ToDictionary_WithStringKey_CreatesDictionary()
        {
            ...
            // Act
            var result = helper.ToDictionary<Category, string, int>(categories, keySelector, valueSelector);
