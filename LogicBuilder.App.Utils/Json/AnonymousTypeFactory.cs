...
namespace LogicBuilder.App.Utils.Json
{
    internal static class AnonymousTypeFactory
    {
        ...
        private const string TempAssemblyName = "LogicBuilder.App.Utils.Json";
        ...
        public static Type CreateAnonymousType(IDictionary<string, Type> memberDetails)
        {
            ...
            return typeBuilder.CreateTypeInfo()!.AsType();//typeBuilder.CreateTypeInfo() not null in .NET 10
        }
